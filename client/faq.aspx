<%@ Page Title="" Language="C#" MasterPageFile="~/client/MasterPage.master" AutoEventWireup="true" CodeFile="faq.aspx.cs" Inherits="client_Default" %>
    ...
    <section class="section-b-space">
        <div class="container">
            ...
            <div class="row g-4">
                <div class="col-xl-4">
                    <div class="side-img">
                        <img class="img-fluid img" src="assets/images/faq.svg" alt="faq">
                    </div>
                </div>
                <div class="col-xl-8">
